//
//  FindConnectionsViewModelTests.swift
//  EvidensTests
//
...
final class FindConnectionsViewModelTests: XCTestCase {
    
    var sut: FindConnectionsViewModel!
    ...
    override func setUpWithError() throws {
        ...
        sut = FindConnectionsViewModel(user: user)
    }
