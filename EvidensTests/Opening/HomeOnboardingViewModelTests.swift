//
//  HomeOnboardingViewModelTests.swift
//  EvidensTests
//
...
final class HomeOnboardingViewModelTests: XCTestCase {

    var sut: HomeOnboardingViewModel!
    ...
    override func setUpWithError() throws {
        ...
        sut = HomeOnboardingViewModel(user: user)
    }
