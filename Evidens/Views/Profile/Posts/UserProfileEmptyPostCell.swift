//
//  UserProfileEmptyPostCell.swift
//  Evidens
//
...
class UserProfileEmptyPostCell: UICollectionViewCell {
    ...
    func configure(user: User) {
        if user.isCurrentUser {
            titleLabel.text = AppStrings.Profile.Post.emptyTitle
            contentLabel.text = AppStrings.Profile.Post.emptyContent
        } else {
            titleLabel.text = user.firstName! + " " + AppStrings.Profile.Post.othersEmptyTitle
            contentLabel.text = AppStrings.Profile.Post.othersEmptyContent
        }
    }
}
