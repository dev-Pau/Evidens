//
//  UserProfileEmptyCommentCell.swift
//  Evidens
//
...
class UserProfileEmptyCommentCell: UICollectionViewCell {
    ...
    func configure(user: User) {
        if user.isCurrentUser {
            postTextLabel.text = AppStrings.Profile.Comment.emptyTitle
            postTextSubLabel.text = AppStrings.Profile.Comment.emptyContent
        } else {
            postTextLabel.text = user.firstName! + " " + AppStrings.Profile.Comment.othersEmptyTitle
            postTextSubLabel.text = AppStrings.Profile.Comment.othersEmptyContent
        }
    }
}
