...
class CaseTagCell: UICollectionViewCell {
    ...
    private let tagLabel: UILabel = {
        ...
        label.font = UIFont.addFont(size: 11.5, scaleStyle: .largeTitle, weight: .semibold)
        return label
    }()
    ...
    private func configure() {
        ...
        let insets = UIFont.addFont(size: 13, scaleStyle: .largeTitle, weight: .semibold).lineHeight / 2
