//
//  SkeletonBookmarks.swift
//  Evidens
//
//  Created by Pau Fernández Solà on 4/11/22.
//
...
class SekeletonCaseBookmarksImageTextCell: UICollectionViewCell, SkeletonLoadable {
    ...
    private func configure() {
        ...
        cellContentView.addSubviews(profileImageLabel, fullNameLabel, categoryLabel, timestampLabel, caseStageLabel, caseImageLabel, firstTextLabel, secondTextLabel, thirdTextLabel, imageLabel)
        ...
        NSLayoutConstraint.activate([
            ...
            caseImageLabel.topAnchor.constraint(equalTo: caseStageLabel.bottomAnchor, constant: 10),
            caseImageLabel.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -10),
            caseImageLabel.heightAnchor.constraint(equalToConstant: 75),
            caseImageLabel.widthAnchor.constraint(equalToConstant: 75),
            ...
            firstTextLabel.trailingAnchor.constraint(equalTo: caseImageLabel.leadingAnchor, constant: -10),
            ...
            secondTextLabel.trailingAnchor.constraint(equalTo: caseImageLabel.leadingAnchor, constant: -10),
            ...
            thirdTextLabel.trailingAnchor.constraint(equalTo: caseImageLabel.leadingAnchor, constant: -60),
