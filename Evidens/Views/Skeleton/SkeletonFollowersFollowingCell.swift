//
//  SkeletonFollowersFollowingCell.swift
//  Evidens
//
//  Created by Pau Fernández Solà on 18/10/22.
//

import UIKit

class SkeletonFollowersFollowingCell: UITableViewCell, SkeletonLoadable {
    ...
    private func configure() {
        ...
        contentView.addSubviews(profileImageLabel, followButtonLabel, fullNameLabel, categoryLabel)
        
        contentView.heightAnchor.constraint(equalToConstant: 73).isActive = true
        
        NSLayoutConstraint.activate([
            profileImageLabel.topAnchor.constraint(equalTo: contentView.topAnchor, constant: paddingTop),
            profileImageLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: paddingLeft),
            ...
            fullNameLabel.topAnchor.constraint(equalTo: contentView.topAnchor, constant: paddingTop),
