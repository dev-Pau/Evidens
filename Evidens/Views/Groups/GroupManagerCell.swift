...
class GroupManagerCell: UICollectionViewCell {
    ...
    private lazy var dotsButton: UIButton = {
        ...
        button.configuration?.image = UIImage(systemName: "ellipsis", withConfiguration: UIImage.SymbolConfiguration(weight: .medium))?.withRenderingMode(.alwaysOriginal).withTintColor(lightGrayColor).scalePreservingAspectRatio(targetSize: CGSize(width: 20, height: 20))
    ...
    private lazy var groupTitleLabel: UILabel = {
        ...
        label.layer.contentsGravity = .left
    ...
    private func configure() {
        ...
        cellContentView.backgroundColor = .white
        cellContentView.addSubviews(bannerImageView, profileGroupImageView, groupTitleLabel, dotsButton, membersCollectionView, groupSizeLabel)
        ...
        NSLayoutConstraint.activate([
            ...
            profileGroupImageView.heightAnchor.constraint(equalToConstant: 70),
            profileGroupImageView.widthAnchor.constraint(equalToConstant: 70),
            
            dotsButton.topAnchor.constraint(equalTo: bannerImageView.bottomAnchor, constant: 10),
            ...
            //groupNameButton.trailingAnchor.constraint(equalTo: cellContentView.trailingAnchor, constant: -10),
            
            groupTitleLabel.topAnchor.constraint(equalTo: profileGroupImageView.bottomAnchor, constant: 5),
            groupTitleLabel.leadingAnchor.constraint(equalTo: profileGroupImageView.leadingAnchor),
            groupTitleLabel.trailingAnchor.constraint(equalTo: dotsButton.leadingAnchor, constant: -10),
            
            
            membersCollectionView.topAnchor.constraint(equalTo: groupTitleLabel.bottomAnchor, constant: 5),
            membersCollectionView.leadingAnchor.constraint(equalTo: profileGroupImageView.leadingAnchor),
    ...
    func configureGroup() {
        ...
        groupTitleLabel.text = viewModel.groupName
