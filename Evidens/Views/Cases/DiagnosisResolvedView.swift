...
protocol DiagnosisResolvedViewDelegate: AnyObject {
    func didTapEdit()
}

class DiagnosisResolvedView: UIView {
    
    private var isExpanded: Bool = false
    
    weak var delegate: DiagnosisResolvedViewDelegate?
    ...
    private func configure() {
        addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(handleEdit)))
