        ...
        viewModel.editReply(comment, withId: id, withCurrentUser: currentUser) { [weak self] error in
            ...
            if let error {
                ...
                if id == strongSelf.viewModel.comment.id {
                    ...
                    strongSelf.postDidChangeComment(postId: strongSelf.viewModel.post.postId, path: strongSelf.viewModel.path, comment: strongSelf.viewModel.comment, action: .edit)
                    ...
                    strongSelf.postDidChangeComment(postId: strongSelf.viewModel.post.postId, path: strongSelf.viewModel.path, comment: strongSelf.viewModel.comments[index], action: .edit)
                }
