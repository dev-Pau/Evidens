...
protocol ReplyActionButtonViewDelegate: AnyObject {
    func handleLikes()
    func handleShowLikes()
}

class ReplyActionButtonView: UIView {
    
    weak var delegate: ReplyActionButtonViewDelegate?
