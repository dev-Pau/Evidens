...
class NotificationTargetView: UIView {
    ...
    private let targetImageView: UIImageView = {
        ...
        iv.image = UIImage(systemName: "circle")?.withRenderingMode(.alwaysOriginal).withTintColor(separatorColor!)
    ...
    private func configureImage() {
        targetImageView.image = UIImage(systemName: isOn ? "checkmark.circle.fill" : "circle")?.withRenderingMode(.alwaysOriginal).withTintColor((isOn ? primaryColor : separatorColor)!)
    }
