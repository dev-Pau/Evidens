...
protocol CaseToolbarDelegate: AnyObject {
    func didTapIndex(_ index: Int)
}

class CaseToolbar: UIToolbar {
    weak var toolbarDelegate: CaseToolbarDelegate?
...
extension CaseToolbar: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return CaseCategory.allCases.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.label.text = CaseCategory.allCases[indexPath.row].title
        return cell
    }
