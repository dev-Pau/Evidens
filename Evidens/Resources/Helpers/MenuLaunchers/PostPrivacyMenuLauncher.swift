...
extension PostPrivacyMenuLauncher: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.row == selectedIndex {
            cell.selectedOptionButton.configuration?.image = UIImage(systemName: AppStrings.Icons.checkmarkCircleFill)
        } else {
            cell.selectedOptionButton.configuration?.image = UIImage(systemName: AppStrings.Icons.circle)
        }
        return cell
    }
