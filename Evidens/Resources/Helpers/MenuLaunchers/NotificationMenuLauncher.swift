//
//  NotificationMenuLauncher.swift
//  Evidens
//
...
private let cellReuseIdentifier = "NotificationMenuCellReuseIdentifier"
private let headerReuseIdentifier = "NotificationMenuHeaderReuseIdentifier"

class NotificationMenuLauncher: NSObject {
    ...
    private var menuOptionsText: [String] = ["Delete notification"]
    ...
    func showNotificationSettings(in view: UIView) {
...
extension NotificationMenuLauncher: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, UICollectionViewDelegate {
